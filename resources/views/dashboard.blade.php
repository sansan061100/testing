<html lang="en">
<head>
    <!-- Copyright @ 2021 Sistem Pakar Pendeteksi Penyakit Burung Lovebird Menggunakan Metode Forward Chaining -->
    <!-- Meta TAG -->
    <meta charset="UTF-8" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <meta name="viewport" content="user-scalable=no, initial-scale=1, maximum-scale=1, minimum-scale=1, width=device-width, height=device-height, target-densitydpi=device-dpi" />
    <meta name="title" content="Sistem Pakar Pendeteksi Penyakit Burung Lovebird Menggunakan Metode Forward Chaining" />
    ...
    <!-- Favicon Website -->
    <link rel="icon" href="{{ asset('/assets/img/logo.png') }}" alt="logo" />
    <!-- CSS -->
...
<body>
    ...
    <section class="home">
        <div class="container">
                ...
                <nav class="navbar navbar-expand-lg navbar-light pt-lg-3">
                    <div class="container">
                        ...
                        <div class="navbar-brand">
                            <img src="{{ asset('/assets/img/logo_only.png') }}" alt="logo_only" loading="lazy" />
                        </div>
            ...
            <div style="margin-top: 50px;" class="banner col-10 mx-auto position-relative p-2 mb-3 mb-lg-0">
                <div class="container">
    ...
    <section class="about" id="about">
        <div class="container pt-5 pb-5">
            <div class="row d-flex justify-content-center align-items-center">
                <div class="col-sm-6">
                    <img class="pb-3 pb-lg-0" src="{{ asset('assets/img/star.png') }}" alt="start" loading="lazy" />
                </div>
                <div class="col-sm-6">
    ...
    <section class="step">
        <div class="container pt-5 pb-5">
            <h1 class="fw-bold mb-3">
                ...
                Berdasarkan Gejala Pada Burung Lovebird mu
            </h1>
            <div class="row d-flex justify-content-center align-items-center">
                <div class="col-sm-4">
                ...
                <div class="col-sm-4">
                    ...
                    <p>Akan muncul pertanyaan terkait gejala, anda tinggal jawab sesuai gejala yang di alami </p>
                </div>
                <div class="col-sm-4">
            ...
            <div class="row">
                ...
                <div class="col-sm-4" id="contact">
                    ...
                    <form action="{{ url('/') }}" method="post">
                        ...
                        <textarea name="subject" class="form-control mb-2" rows="3" placeholder="Pesan..." required></textarea>
                        <button type="submit" class="btn btn-primary float-end" value="add">Kirim</button>
                    </form>
                </div>
            </div>
        </div>
        <p class="p-2 text-center">Copyright <span class="iconify-inline" data-icon="ant-design:copyright-circle-outlined" data-width="15"></span> 2021 Sistem Pakar Pendeteksi Penyakit Burung Menggunakan Metode <b>Forward Chaining</b></p>
    </footer>
    <!-- Footer End -->
